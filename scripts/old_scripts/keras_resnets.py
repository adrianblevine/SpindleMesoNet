...
def ResNet(input_shape=None, classes=2, block='bottleneck', residual_unit='v1',
...
def ResNet18(input_shape, classes):
    ...
    return ResNet(input_shape, classes, basic_block, repetitions=[2, 2, 2, 2],
                  include_top=True, final_pooling='avg')
...
if __name__ == "__main__":
    ...
    model = ResNet18((3, 512, 512), 2)
    print(model.summary())
    import pdb;pdb.set_trace()
    model.load_weights('/projects/alevine_prj/test_dir/model_weights.h5')
